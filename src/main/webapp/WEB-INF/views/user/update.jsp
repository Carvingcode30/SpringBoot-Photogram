		...
		<article class="setting__content">
			...
			<form id="profileUpdate" onsubmit="update(${principal.user.id}, event)">
				...
				<div class="content-item__11">
					...
					<div class="item__input">
					<!-- 
					Spring Security는 인증된 사용자의 정보를 세션에 저장합니다.
header.jsp에서 이 세션 정보를 'principal'이라는 변수로 가져옵니다.
이 'principal' 변수는 모든 포함된 JSP 페이지에서 사용할 수 있게 됩니다.
update.jsp에서는 이 'principal' 변수를 통해 인증된 사용자의 ID에 접근합니다.
					 -->
						<button>제출</button>
					</div>
				</div>
